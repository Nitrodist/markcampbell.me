...
- To name a few of the tools I used, honeybadger, webpacker, turbolinks, momentjs, jquery, font awesome, flatpickr, bootstrap, searchkick, sidekiq (redis), activejob, quickbooks, mailchimp, newrelic, imgproxy, slim templating, and capybara/cuprite/selenium
